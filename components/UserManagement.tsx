            ...
            <div className="bg-white dark:bg-dark-card rounded-lg shadow-xl w-full max-w-lg">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <input type="text" name="realName" placeholder="Nome Real" value={formData.realName} onChange={handleChange} required className="sm:col-span-2 p-2 border dark:border-dark-border rounded-md bg-white dark:bg-gray-800" />
                        <input type="text" name="username" placeholder="Nome de Usuário" value={formData.username} onChange={handleChange} required className="p-2 border dark:border-dark-border rounded-md bg-white dark:bg-gray-800" />
                        <input type="email" name="email" placeholder="E-mail" value={formData.email} onChange={handleChange} required className="p-2 border dark:border-dark-border rounded-md bg-white dark:bg-gray-800" />
                        ...
                        <input type="password" name="password" placeholder={user ? 'Deixe em branco para não alterar' : 'Senha'} value={formData.password} onChange={handleChange} required={!user} className="sm:col-span-2 p-2 border dark:border-dark-border rounded-md bg-white dark:bg-gray-800" />
                    </div>
